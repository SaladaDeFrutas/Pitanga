...
<body class = pagina>
	...
	<form action= "alteracaoFilmeFuncionarios" method="post">
 			<button type="submit" name = "idAtracao" value ="${filme.idAtracao}" class="btn btn-default">Alterar Filme
 			</button>
	</form>
	
	<form action= "exclusaoFilmeFuncionarios" method="post">
 			<button type="submit" name = "idAtracao" value ="${filme.idAtracao}" class="btn btn-default" 
	...
	<form action= "alteracaoPecaFuncionarios" method="post">
 		<button type="submit" name = "idAtracao" value ="${peca.idAtracao}" class="btn btn-default">Alterar Peça
 		</button>
	</form>
	...
	<form action= "exclusaoPecaFuncionarios" method="post">
 		<button type="submit" name = "idAtracao" value ="${peca.idAtracao}" class="btn btn-default"
 			onClick="return confirm('Deseja mesmo excluir?')">Excluir Peça
 		</button>
	</form>
	<br>
	</c:forEach>
