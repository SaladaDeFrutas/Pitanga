...
<form action="lugares" method="get">
        ...
        <c:forEach items="${tiposIngressos}" var="tipoIngresso" varStatus="status">
            ...
            <tr>
                ...
                <td class=tipoIngressos>
                    ...
                    <select class="form-control" name="quantidadeIngresso"
                            id="quantidadeIngresso${status.index }">
    ...
    <button type="submit" class="btn btn-default"
            onClick="return validaEscolherIngressos(${fn:length(tiposIngressos)})">Enviar
    </button>
