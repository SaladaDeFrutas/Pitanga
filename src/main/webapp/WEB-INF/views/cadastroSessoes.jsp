...
<form action="cadastroSessoesFilmeFuncionarios" method="post">
    <button type="submit" name="submitCadastrarFilme" value="" class="btn btn-default">Sessões para
        Filmes
    </button>
</form>
<br><br>
<form action="cadastroSessoesPecaFuncionarios" method="post">
    <button type="submit" name="submitCadastrarPeca" value="" class="btn btn-default">Sessões para
        Pecas
    </button>
</form>
