...
<c:if test="${not empty sessoes}">
    ...
    <c:forEach items="${sessoes}" var="sessao">
        <form action="alteracaoSessaoFilmeFuncionarios" method="post">
            ...
            <button type="submit" name="idSessao" value="${sessao.idSessao}"
                    class="btn btn-default"> Alterar Sessão
            </button>
        </form>
        ...
        <form action="exclusaoSessaoFuncionarios" method="post">
            <button type="submit" name="idSessao" value="${sessao.idSessao}" class="btn btn-default"
                    onClick="return confirm('Deseja mesmo excluir?')"> Excluir Sessão
            </button>
        </form>
        <br>
    </c:forEach>
