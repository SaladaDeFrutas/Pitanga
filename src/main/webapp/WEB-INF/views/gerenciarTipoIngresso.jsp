...
<form action="cadastroTipoIngressoFuncionarios" method="post">
    <button type="submit" name="submitCadastrar" value="" class="btn btn-default">Cadastrar tipo de
        ingresso
    </button>
</form>
<br><br>
<form action="mostrarTipoIngressoFuncionarios" method="post">
    <button type="submit" name="submitMostrar" value="" class="btn btn-default">Mostrar tipos de
        ingresso
    </button>
</form>
