...
<%@ taglib tagdir="../tags" prefix="jsTag" %>
<!DOCTYPE html>
<html>
<head>
...
<br>
<h3 class=pagina>Altera��o de Filme</h3>
...
<form class=pagina action="alterarFilmeFuncionarios" method="post">
    ...
    Dura��o (em minutos):<br><input type="text" name="duracao" value="${filme.duracao}"><br>

    <form:errors path="filme.sinopse"/><br>
    <br><label for="sinopse">Sinopse:</label>
    <textarea class="form-control" rows="4" id="sinopse"
              name="sinopse">${filme.sinopse}</textarea><br>
    ...
    <select class="selectpicker" name="genero">
        <c:choose>
            <c:when test="${filme.genero =='Acao'}">
                <option value="Acao" selected="selected">A��o</option>
            ...
            <c:when test="${filme.genero =='Comedia'}">
                ...
                <option value="Comedia" selected="selected">Com�dia</option>
                <option value="Drama">Drama</option>
                <option value="Suspense">Suspense</option>
                <option value="Terror">Terror</option>
                <option value="Ficcao Cientifica">Fic��o Cient�fica</option>
            ...
            <c:when test="${filme.genero =='Ficcao Cientifica'}">
                ...
                <option value="Suspense">Suspense</option>
                <option value="Terror">Terror</option>
                <option value="Ficcao Cientifica" selected="selected">Fic��o Cient�fica</option>
            </c:when>
            <c:otherwise>
                <option value="Acao">A��o</option>
                <option value="Comedia">Com�dia</option>
