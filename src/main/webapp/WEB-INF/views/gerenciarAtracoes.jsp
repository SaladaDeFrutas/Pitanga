...
<title>Gerenciar Atrações</title>
</head>

<body class = pagina>
	
	<h3>Gerenciar Atrações</h3> <br>
	<form action= "cadastroAtracoesFuncionarios" method="post">
 		<button type="submit" name = "submitCadastrar" value ="" class="btn btn-default">Cadastrar Atrações
 		</button>	
	</form>
	<br><br>
	<form action= "mostrarAtracoesFuncionarios" method="post">
 		<button type="submit" name = "submitMostrar" value ="" class="btn btn-default">Mostrar Atrações
 		</button>	
	</form>
