...
<form action="cadastroFilmeFuncionarios" method="post">
    <button type="submit" name="submitCadastrarFilme" value="" class="btn btn-default">Cadastrar
        Filmes
    </button>
</form>
<br><br>
<form action="cadastroPecaFuncionarios" method="post">
    <button type="submit" name="submitCadastrarPeca" value="" class="btn btn-default">Cadastrar
        Pecas
    </button>
</form>
