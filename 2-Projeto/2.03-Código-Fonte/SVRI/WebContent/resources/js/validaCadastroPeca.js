/**
 * funcao JS que valida a senha para cadastro de pecas
 * 
 * @returns {Boolean} - true se os campos conferem e false se nao conferem 
 */
function validaCadastroPeca(){
    ...
    if(pattLetras.test( diretor ) == false) {
        alert('O nome do diretor deve conter apenas letras maiusculas e minusculas sem caracteres especiais.');
        return false
     }
