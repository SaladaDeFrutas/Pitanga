...
<body class = pagina>
	...
	<form action= "sessoesFilmeFuncionarios" method="post">
 			<button type="submit" name = "idAtracao" value ="${filme.idAtracao}" class="btn btn-default">Listar Sessões
 			</button>
	</form>
	<br>
	</c:forEach>
	...
	<form action= "sessoesPecaFuncionarios" method="post">
 		<button type="submit" name = "idAtracao" value ="${peca.idAtracao}" class="btn btn-default"> Listar Sessões
 		</button>
	</form>
